<div class="panel_informativo">
    <h1 class="titulo">lista de vehiculo</h1>
    <div class="busqueda">
        ...
        <div class="boton_agregar">
            <button type="button" class="btn" data-toggle="modal" data-target="#nuevovehiculo">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="#">
                                                            <button type="button" class="btn btn-outline-success"
                                                                data-toggle="modal" data-target="#editarvehiculo">
